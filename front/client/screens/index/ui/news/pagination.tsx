...
const Pagination = () => {
    ...
    return <Container>
        <Button aria-label='prev' onClick={() => setPageIndex(pageIndex - 1)}>
        ...
        <Button aria-label='next' onClick={() => setPageIndex(pageIndex + 1)}>
            <svg width="27" height="10" viewBox="0 0 27 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const Tab = styled.p<any>`
    font-weight: 500;
    font-size: 20px;
    line-height: 28px;
    border-bottom: ${(props:any) => props.active ? 'solid 2px' : ''};
    color: ${(props:any) => props.active ? '#2F4395' : 'rgba(50, 50, 50, 0.5)'};
    margin-bottom: 0;
    cursor: pointer;
    transition: .2s;
