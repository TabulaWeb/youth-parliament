...
const StepApples = ({
  ...
  return <Container step={step}>
    <Select answers={optionsAdress} tooltip='123' placeholder='Адресат обращения' />

    <Select answers={optionsTheme} tooltip='123' placeholder='Тематика обращения' />
