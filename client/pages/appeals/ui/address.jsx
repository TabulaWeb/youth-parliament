...
const Address = () => {
    return <Container>
        ...
        <AddressBody>
            <AddressText>
                Добрый день, Меня зовут Елизавета мне 18 лет, я была под опекой и стояла на очереди на квартиру так как по месту прописки жить не могу , есть справка о том что отчим болен и временами лежим в психиатрической больнице в городе Великие Луки, мне сказали что 2022 дадут квартиру в городе Новосокольники квартиру. В итоге мне 18 лет когда я позвонила и спросила когда же я получу обещанную квартиру мне сказали извините. Не известно если хотите быстрее то нанимайте юриста или адвоката, я в месяц получаю пенсию 13849,69 И естественно денег на адвоката или юриста у меня нет. И что же мне тогда делать? Решила написать вам. Заранее спасибо.
            </AddressText>
        </AddressBody>
    </Container>
}
