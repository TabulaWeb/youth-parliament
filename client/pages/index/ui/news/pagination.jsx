...
const Pagination = () => {
    ...
    return <>
        ...
        <Container>
            ...
            <Button onClick={() => setPageIndex(pageIndex + 1)}>
                <svg width="27" height="10" viewBox="0 0 27 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M-2.113e-07 5.29126C-1.83629e-07 5.90789 0.499876 6.40777 1.1165 6.40777L21.7509 6.40777L20.3733 7.30097C20.1808 7.42429 19.995 7.54511 19.8249 7.65673C19.3417 7.97383 19.2103 8.6202 19.523 9.10632C19.8408 9.6005 20.4959 9.74624 20.991 9.42979C22.8057 8.26986 26.7698 5.72829 26.9687 5.53398C27.1581 5.33981 26.5382 4.7767 23.7485 2.64078C22.7768 1.89372 21.8776 1.21819 21.2322 0.737399C20.7065 0.345746 19.9586 0.515357 19.6482 1.09281C19.3927 1.56812 19.5274 2.15902 19.9614 2.47961C20.2191 2.66993 20.5151 2.88971 20.8038 3.1068L22.2503 4.17476L1.11651 4.17476C0.499878 4.17476 -2.3897e-07 4.67463 -2.113e-07 5.29126Z" fill="#323232" fill-opacity="0.5"/>
                </svg>
            </Button>
        </Container>
    </>
