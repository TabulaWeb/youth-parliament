...
const ButtonPrev = styled.button`
    ...
    &:hover{
        ...
        & svg path {
            transition: .4s;
            fill: ${(props:any) => props.noActive ? 'red' : 'blue'};;
            fill-opacity: 1;
        }
    }
`
